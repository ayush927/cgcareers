<?php 
    ...
    function uce_part3_score_calculation_v3_02_24($code, $asmt_variation_3_02_24 , $con)
    {
        $con = $con;
        ...
        $sql = "select * from uce_part2_7 WHERE ".$asmt_variation_3_02_24['where_in'];
