<?php 
        ...
        $pagecount = $pdf->setSourceFile('report_template/uce-v3/client-details.pdf');
        ...
        $pdf->Cell(20, 10,$r_mobile, 0, 0, 'L');
        // $pdf->Cell(20, 10, '846486468', 0, 0, 'L');
        ...
        // $pdf->MultiCell(100, 7, '23 ,DK honey homes, Opp Kolar police station, Kolar road', 0, 'L');
