...
<?php 
    ...
    **/
    ...
    else if($sol=='Overseas_Request')

    {

        $s_class = array('9','10','11','12', '1st Year to Pre-final Year','Final Year','Fresh passout' );

        $c_detail = array('9th','10th','11th','12th', '1st Year to Pre-final Year','Final Year','Fresh passout');

        $person_detail_type = "Class";

        $person_detail_nature ='Overseas Aspirant';
