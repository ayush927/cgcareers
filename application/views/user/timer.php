            ...
            <div class="modal-dialog modal-lg" style='margin-top:160px;'>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <div class="col-md-12">
                            <button data-dismiss="modal" type="button" class="mb-1 btn btn-success timeStart">I have understood the instructions well. I agree to proceed forward</button><br>
                            
                            <button data-dismiss="modal" type="button" class="btn btn-warning timeStart">I have not understood the instructions completely. However, I agree to proceed further</button>
                        </div>
