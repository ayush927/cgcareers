...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?= isset($config['googleTag']) ? $config['googleTag'] : 'G-SZX72KYHDR' ?>"></script> 
    <script> 
        ...
        gtag('js', new Date()); 
        gtag('config', '<?= isset($config['googleTag']) ? $config['googleTag'] : 'G-SZX72KYHDR' ?>'); 
    </script>
