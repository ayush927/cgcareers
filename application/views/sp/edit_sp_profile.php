    ...
    <section class="content">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                <?php
                  ...
                  ?>
                <img src="<?php echo $image ?>" class="product-image" alt="Profile Image">
      ...
      <form action="" method="post">
        ...
        <!-- <div class="input-group mb-3">
          ...
          <input type="tel" class="form-control <?= ( form_error('profile_link')!="" ) ? 'is-invalid' : ''; ?>" name="profile_link" value="<?= isset($user['profile_link']) ? $user['profile_link'] : '' ; ?>" placeholder="Profile Link">
