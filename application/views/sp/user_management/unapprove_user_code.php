...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php 
        ...
        $check_code_available = $this->session->flashdata('check_code_available');
        if(!empty($check_code_available)){
          echo "<div class='alert alert-info'>$check_code_available</div>";
        }
                ...
                <div class="card-body">
                  ...
                  <tbody>
                         <?php 
                            ...
                            $this->db->where($where); */
                            $this->db->where(["reseller_id"=>$email,"status"=>"pending"]);
