                     ...
                     <!-- select  -->
                      <div class="form-group">
                                ...
                                <?php
                                    ...
                                    ?>
                                                            <a <?php if($requestParameter == null)  { ?> onclick="window.open(window.location+'/request-generate','_blank');window.open(this.href,'_self');" href="<?php echo base_url().'baseController/create-request/'.$row->code; ?>/<?= $row->solution ?>/<?= $row->user_id ?>" <?php } else{ ?> onClick="alert('<?= $reportData['report_message'] ?>')" href='#' <?php } ?> >View Report</a><br>
                                    <?php
                                                        }
                                                        else{
                                                            // echo "1-2";
