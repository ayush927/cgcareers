      ...
      <div class="container-fluid">
        ...
        <div class="row" >
                    ...
                    <div class="card bg-cyan" style="min-height: 150px; padding-top:20px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style="min-height: 130px; ">
                                      ...
                                      <div class="col-8" style="opacity: .7; color:black;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style="min-height: 130px; ">
                                      ...
                                      <div class="col-4" style="opacity: .7;">
                                        ...
                                        <img class="bg-yellow" src="<?php echo base_url().'/assets/dist/img/certificate2.png'; ?>" style="height: 90px; width:90px;" alt="Card image cap">                
            ...
            <div class="col-12 col-lg-6 ">
                    ...
                    <div class="card bg-danger" style="min-height: 150px; padding-top:20px;">

                                <div class="card-body">

                                    <a href="<?php echo base_url().'common-action/create-link'; ?>"  style="text-decoration: none; color:white;">

                                    <div class="row" style="min-height: 130px; ">

                                      <div class="col-4" style="opacity: .7;">

                                        <img class="bg-danger" src="<?php echo base_url().'/assets/dist/img/file2.png'; ?>" style="height: 90px; width:90px;" alt="Card image cap">                

                                      </div>

                                      <div class="col-8" style="opacity: .7; color:black;">

                                      <span><h4><b>Change to Create Assessment Link</b></h4></span>
