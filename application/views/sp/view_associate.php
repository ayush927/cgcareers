                  ...
                  <tbody>
                    ...
                    foreach($associate_data as $row){ ?>
                      ...
                      <tr>
                        ...
                        <td><?php echo ($row->contact ? $row->contact : 'N/A' ) ?></td>

                        <td><?php echo $row->associate_type ?></td>

                        <td><a href='<?= base_url() ?>SpController/change-status/<?= $row->id ?>/<?= $row->status == 'active' ? 'inactive' : 'active' ?>'  class='btn btn-<?= $row->status == 'active' ? 'success' : 'danger' ?>' > <?= ucwords($row->status) ?> </a></td>
