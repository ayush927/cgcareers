    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-2 pb-2 mb-2 d-flex">
        <div class="image">
          <?php
            ...
            $getUserFullDetail = getQuery( [ 'where' => [ 'email' => $user['email'] ] , 'table' => 'user_details' , 'single' => true ] );
            $profileViewData = getQuery( [ 'where' => [ 'r_email' => $user['email'] ] , 'table' => 'counsellor_list_status' , 'single'  => true ] );
            // pre( $profileViewData , 1 ); 
            if( !empty( $profileViewdata )){
              if( $profileViewdata["thumbnail"] == 0 ){
                  $img_arr = explode('/' , $user['profile_photo'] );
                  if( $img_arr[count($img_arr) - 1] == 'default.png' ){
                      $image = base_url().'uploads/avatar-100-100.jpg';
                  }
                  elseif( file_exists( './uploads/'.$img_arr[count($img_arr) - 1] ) ){
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo base_url().'SpController/variation-image-list'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Variation Image List</p>
                    </a>
                </li>
            </ul>
          </li> -->
                  ...
                  if($num>0)
                  {
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url().'SpController/spprofile'; ?>" class="nav-link">
                        <i class="far fa-circle nav-icon"></i><p>Update Services</p>
                      </a>
                    </li>
                    <?php
                  }
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview"> 
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/vocational_training/detail'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'/UserController/assessment-variation'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Set Variation</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'UserController/all-booking-link'?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <!-- <li class="nav-item">
                ...
                <ul class="nav nav-treeview"> -->
                    <!--<li class="nav-item">-->
                    <!--    <a href="<?php echo base_url().'UserController/add-booking-link'?>" class="nav-link">-->
                    <!--      <i class="far fa-circle nav-icon"></i>-->
                    <!--      <p>Add Booking Links</p>-->
                    <!--    </a>-->
                    <!--</li>-->
                    <!-- <li class="nav-item">
                        <a href="<?php echo base_url().'UserController/all-booking-link'?>" class="nav-link">
          ...
          ?>
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a target='_blank' href="https://drive.google.com/drive/folders/11XlZdJ3MoozcCAsFKRbIEfIL35mwGUaa?usp=drive_link" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                  <?php
                    if( strpos( $_SERVER['SCRIPT_URI'] , '/dev/' ) ){
                      $pageUrl = 'https://respicite.com/dev/';
                    }
                    else{
                      $pageUrl = 'https://respicite.com/';
                    }
                  ?>
                  <a href="<?= $pageUrl ?>career-library" target="_blank" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Professions</p>
                  </a>
                </li>
          ...
          ;?>
          <?php
            if( $getUserFullDetail['certification_type'] == 'C3E' ){
          ?>
            <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon far fa-user"></i>
          ...
          <li class="nav-item bg-light-gray">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/live-training-list'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Trainings List</p>
                </a>
              </li>              
              </ul>
          </li>
