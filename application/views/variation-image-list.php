                    ...
                    <table class="table table-bordered text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class='btn btn-info' href='<?= base_url() ?>UserController/edit-variation-image/<?= $row['dataId'] ?>' >Edit</a>
                                    <a class='btn btn-info' href='<?= base_url() ?>UserController/delete-variation-image/<?= $row['id'] ?>' >Delete</a>
                                </td>
                            </tr>  
                            <?php 
                                }
