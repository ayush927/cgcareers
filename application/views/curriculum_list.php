...
<div class="content-wrapper bg-white" style="min-height: 706px">
  ...
  <section class="content ">
    <div class="container-fluid">
        ...
        <p class="text-right"><a class="btn btn-sm btn-outline-primary" href="<?php echo base_url();?>skill-development/vocational-training/add-curriculum/<?= base64_encode($id) ?>">Add curriculum</a></p>
        <!-- main content #start -->
        <div class="card">
                ...
                <table class="table table-bordered text-nowrap">
                  ...
                  <tbody>
                    ...
                    ?>                    
                     <tr>  
                        <td><?php echo $v['id'];?></td>
                        <td><p><?= ucwords($v['curriculumTitle']);?></p></td>              
                        <td><p><?= substr( ucfirst($v['short_description']), 0 , 50 );?>...</p></td>              
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-outline-info m-1" href="<?= base_url('skill-development/vocational_training/edit-curriculum/'.base64_encode($v['id'])) ?>">Edit</a><br>
                            <a class="btn btn-sm btn-outline-danger m-1" href="<?= base_url('skill-development/delete-curriculum/'.base64_encode($v['id']));?>"> Delete </a><br>
                        </td>
                    </tr> 
                    <?php 
                            }
