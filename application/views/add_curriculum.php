                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body box-profile">
                            <form action="<?= base_url() ?>skill-development/curriculum-submit" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?> 
                                    <label for="curriculumTitle">Curriculam Title<span class='text-red' > * </span> </label>
                                    <input type='text' name='curriculumTitle' value='<?= !empty( $edit ) ? $edit['curriculumTitle'] : '' ?>'  class='form-control' required  placeholder='Enter Curriculum Title' >
                                </div>
                                <div class="form-group">
                                ...
                                <div class='form-group'>
                                    <label for="curriculumTitle">Upload Curriculam Data<span class='text-red' > * </span> </label>
                                ...
                                <div class="row">
                                    ...
                                    <!-- /.col -->
                                    <div class="col-4">
                                        <button type="submit" class="btn btn-primary btn-block">Submit Curriculum</button>
                                    </div>
                                    <!-- /.col -->
                                </div>
                            </form>
