        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo base_url().'UserController/variation-image-list'; ?>" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                  <a href="<?php echo base_url().'SpController/spprofile'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i><p>Profile Update</p>
                  </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url().'/UserController/skill-development-heading'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Skill development heading</p>
                </a>
              </li>
               <li class="nav-item">
