                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body box-profile">                  
                            <form action="<?= base_url() ?>skill-development/schedulling-submit" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <label for=""> Rescheduled Date Time <span class='text-red' > * </span> </label>
                                    <input type='datetime-local' name='reshceduled_time' value='<?= !empty( $edit ) ? $edit['reshceduled_time'] : '' ?>' class='form-control' required  placeholder='Enter Start date time' >
                                </div>
                                <div class="form-group">
                                    <label for="reschedule_remark">Session Short Description<span class='text-red' > * </span></label>
                                    <textarea name='reschedule_remark' class='form-control' required  placeholder='Enter Short Description' rows='5' ><?= !empty( $edit ) ? $edit['reschedule_remark'] : '' ?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-8">
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-4">
                                        <button type="submit" class="btn btn-primary btn-block">Submit Schedulling</button>
                                    </div>
                                    <!-- /.col -->
                                </div>
                            </form>
