        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                ?>
                    <form action="<?php echo base_url('skill-development/submit-domain') ?>" method="post">
                        ...
                        ?>
                          <input type="text" name="domainName" class="form-control <?php echo (form_error('domainName')!="") ? 'is-invalid' : ''; ?>" placeholder="Enter domain Name" value='<?= !empty( $edit ) ? $edit['domainName']  : "" ?>' required >
                        </div>
                        <div class="row">
                          <div class="col-8">
                          </div>
