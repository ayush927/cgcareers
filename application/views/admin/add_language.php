        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                ?>
                    <form action="<?php echo base_url('skill-development/submit-language') ?>" method="post">
                        <div class="form-group mb-3">
                            ...
                            ?>
                          <input type="text" name="language" class="form-control <?php echo (form_error('language')!="") ? 'is-invalid' : ''; ?>" placeholder="Enter language " value='<?= !empty( $edit ) ? $edit['language']  : "" ?>' required >
                        </div>
                        <div class="row">
                          <div class="col-8">
                          </div>
