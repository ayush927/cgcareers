        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                ?>
                    <form action="<?php echo base_url('skill-development/submit-nature') ?>" method="post">
                        <div class="input-group mb-3">
                            ...
                            ?>
                          <input type="text" name="nature" class="form-control <?php echo (form_error('nature')!="") ? 'is-invalid' : ''; ?>" placeholder="Enter Nature Name" value='<?= !empty( $edit ) ? $edit['nature']  : "" ?>' required >
                        </div>
                        <div class="row">
                          <div class="col-8">
                          </div>
