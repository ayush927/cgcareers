            ...
            <div class="card">
              <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-9">
                    <a class="btn btn-info float-right" style="margin-right:50px;"  href="<?= base_url() ?>AdminController/calendly-config" > Add clusters </a>
                  </div>
                </div>
              </div> 
              <!-- /.card-header -->
                  ...
                  <tbody> 
                    ...
                    ?>
                        <tr>  
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary" href="<?php echo base_url("adminController/edit-calendly-config/").$row['id'];?>">edit</a>
                                <a class="btn btn-sm btn-danger" href="<?php echo base_url("adminController/delete-calendly-config/").$row['id'];?>">Delete</a>
                            </td>
                        </tr>  
                    <?php
                            }
