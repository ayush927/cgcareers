                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                                ...
                                <td>
                                  ...
                                  <br><br>
                                  <a class="btn btn-primary p-1" href="<?php echo base_url()?>/AdminController/allowed_services_update/<?php echo $id; ?>/seller_config" style="white-space: nowrap;text-align: center;" >
                                      <?php $rr = explode(",",$services);
                                      echo (in_array("seller_config", $rr))?'Sellor Config Diable':'Sellor Config Enable'; ?>
                                  </a>
