            ...
            <div class="container-fluid">
                ...
                <section class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-default  <?= isset($edit) ? '' : 'collapsed-card' ?>">
                            <div class="card-header">
                                <h3 class="card-title">Page SEO</h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                        <i class="fas fa-plus"></i>
                                    </button>
                            ...
                            <div class="card-body" <?= isset($edit) ? 'style="display: block;"' : '' ?>>
                                <div class="row">
                                    <div class="col-md-12 d-flex align-items-stretch flex-column">
                                        <div class="card-body">
                                            <form action='<?= base_url() ?>AdminController/page_seo_update'  method='post'>
                                                <?php
                                                    if( isset($edit) ){
                                                ?>
                                                ...
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' name='page_url' class='form-control' value='<?= isset( $edit ) ? ( $edit['page_url'] ) : '' ?>' placeholder='Enter page url' >
                                                </div>
                                                <div class='form-group'>
                                                    <label> Questions </label>
                                                    <input type='text' value='<?= isset( $edit ) ? ( $edit['question'] ) : '' ?>' name='question' class='form-control' placeholder='Enter Question' >
                                                </div>
                                                <div class='form-group'>
                                                    <label> Answer </label>
                                                    <!-- <div id='summernote'></div> -->
                                                    <textarea class='form-control' rows='20' name='answer'  ><?= isset( $edit ) ? ( $edit['answer'] ) : '' ?></textarea>
                                                </div>
                                                <div class='form-group'>
                                                    <!-- <div id='summernote'></div> -->
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= ucwords( $v['question'] );?></td>
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a href="<?= base_url('AdminController/seo_parameter/'.$v['id']); ?>" class="btn btn-primary">Edit</a>
                                                                            <a href="<?php echo base_url('AdminController/seo_page_delete/'.$v['id']);?>" class="btn btn-danger">Delete</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                    <?php
