        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo base_url().'AdminController/variation-report-image'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add Variation Image</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url().'AdminController/variation-image-list'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?php echo base_url().'AdminController/service-list'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Service List</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url().'AdminController/counsellor-list'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Counsellor List</p>
                    </a>
                </li>
          ...
          <!-- <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo base_url().'AdminController/notifications'; ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Notifications</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <ul class='nav nav-treeview'>
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url() ?>AdminController/control-list" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>
                                Control Request
                              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/domain-list'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Domain Management</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/sub-domain-list'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sub-domain Manage</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/level-list'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Level</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/nature'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Nature</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Live Class Credential</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/certification'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Certification Type</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/discount'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Discount</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'skill-development/language'; ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Language</p>
                </a>
              </li>
