        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                ?>
                    <form action="<?php echo base_url('skill-development/submit-certification') ?>" method="post">
                        <div class="input-group mb-3">
                            ...
                            ?>
                          <input type="text" name="certificationName" class="form-control <?php echo (form_error('certificationName')!="") ? 'is-invalid' : ''; ?>" placeholder="Enter Certification Name" value='<?= !empty( $edit ) ? $edit['certificationName']  : "" ?>' required >
                        </div>
                        <div class="row">
                          <div class="col-8">
                          </div>
