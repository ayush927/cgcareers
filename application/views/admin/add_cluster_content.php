                        ...
                        <form action="<?= base_url() ?>/AdminController/update-role-details" method="post" >
                          ...
                          <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                              ...
                              <input type="text"  class="form-control" id="Institute_9_pg"

                              name="Institute_9_pg" value="<?= isset( $edit ) ? $edit['Institute_9_pg'] : set_value('Institute_9_pg') ?>" placeholder="Institute 9 PG">

                              <p class="text-primary m-1 Institute_9_pg"></p>
                            ...
                            <div class="col-sm-4">
                              ...
                              <input type="text"  class="form-control" id="Institute_10_pg"

                              name="Institute_10_pg" value="<?= isset( $edit ) ? $edit['Institute_10_pg'] : set_value('Institute_10_pg') ?>" placeholder="Institute 10 PG">

                              <p class="text-primary m-1 Institute_10_pg"></p>
                      ...
                      <form action="<?= base_url() ?>/AdminController/update-role-details" method="post" >
                          ...
                          <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                              ...
                              <input type="text"  class="form-control" id="Exam_9_pg"

                              name="Exam_9_pg" value="<?= isset( $edit ) ? $edit['Exam_9_pg'] : set_value('Exam_9_pg') ?>" placeholder="Exam 9 PG">

                              <p class="text-primary m-1 Exam_9_pg"></p>
                            ...
                            <div class="col-sm-4">
                              ...
                              <input type="text"  class="form-control" id="Exam_10_pg"

                              name="Exam_10_pg" value="<?= isset( $edit ) ? $edit['Exam_10_pg'] : set_value('Exam_10_pg') ?>" placeholder="Exam 10 PG">

                              <p class="text-primary m-1 Exam_10_pg"></p>
