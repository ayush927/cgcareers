        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                ?>
                    <form action="<?php echo base_url('skill-development/submit-level') ?>" method="post">
                        <div class="input-group mb-3">
                            ...
                            ?>    
                          <input type="text" name="level" class="form-control <?php echo (form_error('level')!="") ? 'is-invalid' : ''; ?>" placeholder="Enter level Name" value='<?= !empty( $edit ) ? $edit['level']  : "" ?>' required >
                        </div>
                        <div class="row">
                          <div class="col-8">
                          </div>
