<?php
...

    {
...

        {
            ...
            $this->email->from('sales@respicite.com', 'Respicite');
...

        {
            ...
            $this->db->where('link_status','enabled');
...

        {
            ...
            if( $sendingEmail != null ){
                ...
                $this->email->from( $sendingEmail , 'Respicite');
            ...
            // die;
                ...
                $this->email->from('notification@respicite.com', 'Respicite');        
        ...
        public function get_user_details($action = null,$id = null){
            ...
            switch($action){
                ...
                case "RESELLER_EVENT_DETAIL":

                    // $this->db->select("id,solution,display_solution_name,mr_price,retail_price,mrp");

                    $this->db->where("id",$id);

                    $q = $this->db->get("calendly_event");
